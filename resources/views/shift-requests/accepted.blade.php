                                    ...
                                    <tbody>
                                        ...
                                        @forelse ($approved as $request)
                                            <tr>
                                                ...
                                                <td>{{ isset($request->user) ? $request->user->email : '' }}</td>
                                                <td>{{ isset($request->user) ? $request->user->phone_number : '' }}</td>

                                                <td>{{ isset($request->shift) ? $request->shift->title : null }}</td>
                                                <td>{{ $request->shift_description }}</td>
                                                <td>
                                                    @if ($request->status == 'pending')
                                                        <form action="{{ url('shift-requests.accept', $request->id) }}"
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="4" class="text-center">No Accepted requests </td>
                                            </tr>
                                        @endforelse
